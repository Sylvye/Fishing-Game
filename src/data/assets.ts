...
export const assetManifest: AssetManifestEntry[] = [
  ...
  fishAsset('fish-atlantic-mackerel', 'Atlantic Mackerel', 'Atlantic-mackerel.png', 'Local placeholder', 'Created for this project.', 'Use a streamlined side-profile mackerel sprite with transparent background.'),
  fishAsset('fish-wahoo', 'Wahoo', 'Wahoo.png', 'Local placeholder', 'Created for this project.', 'Use a fast, long-bodied wahoo sprite with transparent background.'),
  fishAsset('fish-yellowfin-tuna', 'Yellowfin Tuna', 'Yellowfin-tuna.png', 'Local placeholder', 'Created for this project.', 'Use a muscular tuna sprite with transparent background.'),
  fishAsset('fish-giant-trevally', 'Giant Trevally', 'Giant-trevally.png', 'Local placeholder', 'Created for this project.', 'Use a deep-bodied giant trevally sprite with transparent background.'),
  fishAsset('fish-blue-marlin', 'Blue Marlin', 'Blue-marlin.png', 'Local placeholder', 'Created for this project.', 'Use a large billfish sprite with transparent background.'),
  fishAsset('fish-shortfin-mako-shark', 'Shortfin Mako Shark', 'Shortfin-mako.png', 'Local placeholder', 'Created for this project.', 'Use a side-profile mako shark sprite with transparent background.'),
  fishAsset('fish-common-thresher-shark', 'Common Thresher Shark', 'Common-thresher-shark.png', 'Local placeholder', 'Created for this project.', 'Use a thresher shark sprite with a long tail and transparent background.'),
  fishAsset('fish-whale-shark', 'Whale Shark', 'Whale-shark.png', 'Local placeholder', 'Created for this project.', 'Use a huge side-profile whale shark sprite with transparent background.'),
  {
    id: 'rod-bamboo',
    kind: 'rod',
    src: rodBambooUrl,
